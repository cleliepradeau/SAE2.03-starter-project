...
if ( isset($_REQUEST['todo']) ){
  ...
  switch($todo){
    ...
    case 'getMovieCategories':
      $data = readControllerMovieCategorie();
      break;
      
    case 'getCategories':
      $data = readControllerCategorie();
      break;
    ...
    case 'getMovieMiseEnAvant':
      $data = readControllerMovieMiseEnAvant();
      break;

    case 'getBarRecherche':
      $data = readBarRechercheController();
      break;
